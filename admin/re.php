...
<div><span class="title3">VAT (12%): Php <?php echo number_format(($row['total']*0.12),2); ?></span><span><type="text"></span></div>
<div><span class="title3">Tax (5%): Php <?php echo number_format(($row['total']*0.05),2); ?></span><span><type="text"></span></div>
<div><span class="title3">Grand Total: Php <?php echo number_format(($row['total']*1.17),2); ?></span><span><type="text"></span></div>
</div>
